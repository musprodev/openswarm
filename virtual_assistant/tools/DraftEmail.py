...
class DraftEmail(BaseTool):
    ...
    cc: list[str] | None = Field(default=None, description="List of CC recipient email addresses")

    bcc: list[str] | None = Field(default=None, description="List of BCC recipient email addresses")

    is_html: bool = Field(default=False, description="Set to True if body contains HTML formatting")
    ...
    def _create_gmail_draft(self, execute_tool) -> str:
        ...
        arguments = {"user_id": "me", "body": self.body, "is_html": self.is_html}
    ...
    def _create_outlook_draft(self, execute_tool) -> str:
        ...
        arguments = {"body": self.body, "is_html": self.is_html}
